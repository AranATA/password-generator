...
// all array combinations that will generated by user input are defined below.
  ...
  // then that process is repeated till the total number of password characters is reached and the final set of characters are stored in the variable finalCharacters.    
...
function writePassword() {
  ...
  // if the user hits the cancel button then the prompt window disappears.
if (passLengthStr === null){
  location.reload();
}
else { 
